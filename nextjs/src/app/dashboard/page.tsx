    ...
    <main className="relative">
      ...
      <section className="container-app p-5">
        <section className="flex flex-col gap-5">
          <h3 className="text-3xl font-bold tracking-tight text-[--text-color]">Dashboard</h3>
          <a href={discordLink}>
            <div className="flex items-start gap-3 rounded-md bg-gray-600 p-3 text-[--text-color] transition hover:bg-gray-700">
              <svg
                width={48}
                height={48}
                fill="currentColor"
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div style={{borderColor:'var(--border-color)'}} className="boder-black/10 flex flex-col gap-4 rounded-lg border-[1px] p-6 shadow-sm dark:border-white/10 dark:shadow-none">
              <div className="flex items-center justify-between gap-3">
                <span className="font-medium tracking-tight text-[--text-color]">Total Series</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-[--text-color]">{seriesCount.currentMonth}</span>
            ...
            <div style={{borderColor:'var(--border-color)'}} className="boder-black/10 flex flex-col gap-4 rounded-lg border-[1px] p-6 shadow-sm dark:border-white/10 dark:shadow-none">
              <div className="flex items-center justify-between gap-3">
                <span className="font-medium tracking-tight text-[--text-color]">Series Chapters</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-[--text-color]">{chapterCount.currentMonth}</span>
                <span className="text-muted-foreground text-xs text-gray-500">
            ...
            <div style={{borderColor:'var(--border-color)'}} className="boder-black/10 flex flex-col gap-4 rounded-lg border-[1px] p-6 shadow-sm dark:border-white/10 dark:shadow-none">
              <div className="flex items-center justify-between gap-3">
                <span className="font-medium tracking-tight text-[--text-color]">Total Views</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-[--text-color]">{views.currentMonth}</span>
                <span className="text-muted-foreground text-xs text-gray-500">
            ...
            <div style={{borderColor:'var(--border-color)'}} className="boder-black/10 flex flex-col gap-4 rounded-lg border-[1px] p-6 shadow-sm dark:border-white/10 dark:shadow-none">
              <div className="flex items-center justify-between gap-3 text-[--text-color]">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-[--text-color]">{userCount.currentMonth}</span>
                <span className="text-muted-foreground text-xs text-gray-500">
